...
##                    self.pygameWindow.Draw_Line((51,51,255),xBaseNotYetScaled, yBaseNotYetScaled, xTipNotYetScaled, yTipNotYetScaled, 1)
                    ...
                    xBase = self.Scale_Val(xBaseNotYetScaled, -10000, 10000, 0, pygameWindowWidth)
                    yBase = self.Scale_Val(yBaseNotYetScaled, -10000, 10000, 0, pygameWindowHeight)
                    xTip = self.Scale_Val(xTipNotYetScaled, 10000, -10000, 0, pygameWindowWidth)
                    yTip = self.Scale_Val(yTipNotYetScaled, 10000, -10000, 0, pygameWindowHeight)
